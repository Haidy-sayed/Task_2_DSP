...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionShow_reconstructed_on_main = QtWidgets.QAction(MainWindow)
        self.actionShow_reconstructed_on_main.setObjectName("actionShow_reconstructed_on_main")
        ...
        self.menuSignal_processes.addAction(self.actionShow_reconstructed_on_main)
